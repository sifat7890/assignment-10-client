...
const FeatureMovies = ({ movieFeaturedCards }) => {
    ...
    return (
        <div className='mt-16'>
            ...
            <div className='w-11/12 mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4  mb-12' data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="text-center flex justify-center" data-aos="fade-up">
                <Link
                    to="/movies"
